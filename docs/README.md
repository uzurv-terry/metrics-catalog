...
- `architecture/kpi_approver_table_design.md`
- `architecture/code_technical_implementation.md`
- `architecture/performance_optimization_plan.md`
- `architecture/metric_overview_and_notes_solution.md`
- `architecture/metric_owner_sns_notification_solution.md`
...
## Standards
- `standards/web_form_standards.md`
- `standards/web_form_compliance.md`
